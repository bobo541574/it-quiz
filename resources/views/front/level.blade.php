...
<section class="card_section" id="result" style="margin-top: 60px;">
      <div class="row">
        ...
        <div class="col-6">
          ...
          <button class="btn btn_6"style="width: 200px; margin-top: 10px;" value="Checkresult" name="" id="save" data-toggle="modal" data-target="#exampleModalCenter">Save Result</button>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="exampleModalCenterTitle">Info</h4>
                ...
                <div class="modal-body">
                  ...
                  <h2>User Results Data saved in Database</h2>
                  <!-- <h6>Please!, Click User Histroy to see User Results Histroy</h6> -->
                  <h6>If you want to check user results, you need to click "User Name <span class="fas fa-long-arrow-alt-right"></span> User Histroy"</h6>

                </div>
                <div class="modal-footer">
                  <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> -->
                  <button class="btn btn_6"style="width: 50px; margin-top: 10px;" data-dismiss="modal">OK</button>
                </div>
              </div>
            </div>
          </div>
