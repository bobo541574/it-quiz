...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand main_logo" href="index.html"> <img src="{{asset('frondend/img/main.png')}}" alt="logo"></a>
                     
                        <a class="navbar-brand single_page_logo" href="index.html" > <img src="{{asset('frondend/img/mobile.png')}}" alt="logo" ><h2 style="margin-left: 40px; margin-top: 10px; color: white" >IT Test</h2></a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent" style="margin-right: 200px;">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item dropdown dropright">
                                ...
                                <div class="dropdown-menu" style="margin-top: 10px"aria-labelledby="navbarDropdown">
                                    <a class="nav-link"
                                     href="{{url('result/'.Auth::user()->id)}}">User History</a>
    ...
    <!--::footer_part start::-->
   <footer class="footer_part" style="margin-top: 100px; background-image: url({{asset('frondend/img/foot14.png')}});">
             ...
             <hr class="clearfix w-100 d-md-none pb-3">
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="https://www.facebook.com"><img src="{{asset('frondend/img/f.svg')}}" width="25" height="25" style="margin-bottom: 10px;"> </a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com"><img src="{{asset('frondend/img/i.svg')}}" width="25" height="25" style="margin-bottom: 10px;"> </a>
                        </li>
                        <li>
                            <a href="https://www.twitter.com"><img src="{{asset('frondend/img/t.svg')}}" width="25" height="25" style="margin-bottom: 10px;"> </a>
