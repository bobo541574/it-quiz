...
<div class="feedback-section" style=" ">
  ...
  <div class="card card-image "
    ...
    <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
      ...
      <!--Body-->
      <form action="{{url('sendemail/send')}}" method="POST" onsubmit="alert('Going!')">
        @csrf
      <div class="md-form">
        <input type="text" id="Form-email5" class="form-control white-text" name="name">
        <label for="Form-email5">Your Name</label>
      </div>

      <div class="md-form pb-3">
        <input type="email" id="Form-pass5" class="form-control white-text" name="email">
        <label for="Form-pass5">Your Email</label>
        
      </div>

      <div class="md-form">
        
        <textarea type="text" id="Form-email5" class="form-control white-text" name="message"></textarea>
      ...
      <div class="row d-flex align-items-center mb-4">
        ...
        <div class="text-center mb-3 col-md-12">
          <button type="submit" class="btn btn-primary btn-block btn-rounded z-depth-1" >Send</button>
        </div>
        <!--Grid column-->
      </div>
      </form>
